...
public class JsonParserBigNumeric extends JmesPathBaseVisitor<Object> {
    ...
    public static Object fromString(String json, Adapter<Object> runtime) {
        ...
        if (errors.isEmpty()) {
            return new JsonParserBigNumeric(tree, (ConnectJMESPathRuntime) runtime).object();
        } else {
            throw new ParseException(json, errors);
        }
    }

    private JsonParserBigNumeric(ParseTree tree, ConnectJMESPathRuntime runtime) {
        this.tree = tree;
